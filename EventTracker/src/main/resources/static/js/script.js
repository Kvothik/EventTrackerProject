		...
		if (xhr.readyState === 4 && xhr.status < 400) {
			...
			movieObject
					.forEach(function(v, i, a) {
						...
						releaseYearLi.textContent = 'Release Year: '
								+ v.releaseDate;
		...
		if (xhr.readyState === 4 && xhr.status < 400) {
			...
			movieObject
					.forEach(function(v, i, a) {
						...
						var deleteButton = document.createElement("BUTTON");
						deleteButton.textContent = 'Delete';
						deleteButton.onclick = "deleteMovie(v.id)"
						miscUl.appendChild(deleteButton);
...
function deleteMovie(id){
	...
	xhr.open("DELETE", 'api/movie/' + id, true);
	xhr.setRequestHeader("Content-type", "application/json"); // Specify JSON
