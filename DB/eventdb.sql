...
START TRANSACTION;
USE `eventdb`;
INSERT INTO `movie` (`id`, `title`, `length`, `rating`, `type`, `description`, `trailer`, `director`, `cast`, `release_date`, `img_url`) VALUES (1, 'Star Wars: The Rise of Skywalker', '141', NULL, ' Action, Adventure, Fantasy', 'The surviving Resistance faces the First Order once more in the final chapter of the Skywalker saga.', 'https://www.youtube.com/embed/8Qn_spdM5Zg', ' J.J. Abrams', ' Adam Driver, Daisy Ridley, Billie Lourd', '2019-12-20', 'https://m.media-amazon.com/images/M/MV5BMDljNTQ5ODItZmQwMy00M2ExLTljOTQtZTVjNGE2NTg0NGIxXkEyXkFqcGdeQXVyODkzNTgxMDg@._V1_UX182_CR0,0,182,268_AL_.jpg');
